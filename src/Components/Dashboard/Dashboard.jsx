...
import { Activity, Calendar3, Cart3, CurrencyRupee, Envelope, GraphUpArrow, Percent, Plus, Save, StarFill, StarHalf } from 'react-bootstrap-icons'
                                            ...
                                            <div className='card'>
                                                    ...
                                                    <div className="flex-grow-1 col ms-1">
                                                        ...
                                                        <div className="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                                            <a className="bg-light rounded p-1" href="index.html">
                                                                <img src='../img/img-8.png' alt="t-shirt" className="img-fluid d-block" />
                                                            </a>
                                                            <a className="bg-light rounded p-1" href="index.html">
                                                                <img src='../img/img-2.png' alt="" className="img-fluid d-block" />
                                                            </a>
                                                            <a className="bg-light rounded p-1" href="index.html">
                                                                <img src='../img/img-10.png' alt="" className="img-fluid d-block" />
                                                            </a>
                                                        </div>
                                                ...
                                                <div className="acitivity-item py-3 d-flex ms-3 ">
                                                    <div className="flex-shrink-0 ico ms-0">
                                                        <img src='../img/avatar-2.jpg' alt="" className="avatar-xs rounded-circle acitivity-avatar" />
                                                    </div>
                                                            ...
                                                            <div className="card-body">
                                                                <div className="d-flex">
                                                                    <div className="flex-shrink-0 roll">
                                                                        <img src='../img/avatar-2.jpg' alt='' className="avatar-sm rounded" />
                                                                    </div>
                                                                    <div className="flex-grow-1 ms-3">
                                                                        <div>
                                                                            <p className="text-muted mb-1 fst-italic text-truncate-two-lines">
                                                    ...
                                                    <div className="swiper-slide" data-swiper-slide-index={3} style={{ height: 150, marginBottom: 10 }}>
                                                        <div className="border border-dashed shadow-none card mt-1">
                                                            <div className="card-body ">
                                                                <div className="d-flex">
                                                                    <div className="flex-shrink-0 roll">
                                                                        <img src='../img/avatar-3.jpg' alt='' className="avatar-sm rounded" />
                                                                    </div>
                                                                    <div className="flex-grow-1 ms-3">
                                                                        <div>
                ...
                <div className='row'>
                    <div className='col-xl-3 col-sm-6 mb-3'>
                        <div className='card text-white bg-success o-hidden h-100'>
                            ...
                            <Link className="card-footer text-white clearfix small z-1" to="/productview">
                    ...
                    <div className='col-xl-3 col-sm-6 mb-3'>
                        <div className='card text-white bg-primary o-hidden h-100'>
                            <div className='card-body'>
                                <div className='text-center card-font-size p-3'>
                                    Total Amount <br></br>
                                    <span><CurrencyRupee />{totalPrice}</span>
                                </div>
                            </div>
                            <Link className="card-footer text-white clearfix small z-1" to="/productview">
                                <span className='float-left'>
